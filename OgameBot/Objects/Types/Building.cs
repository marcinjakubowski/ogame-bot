namespace OgameBot.Objects.Types
{
    public class Building : BaseGrowingCostEntity<BuildingType, Building>
    {
        ...
        public static Building JumpGate             { get; } = new Building(BuildingType.JumpGate            , new Cost(2000000, 4000000, 2000000, 1.0f));
        public static Building LunarBase            { get; } = new Building(BuildingType.LunarBase           , new Cost(20000, 40000, 20000, 2.0f));
        ...
        public static Building SensorPhalanx        { get; } = new Building(BuildingType.SensorPhalanx       , new Cost(20000, 40000, 20000, 2.0f));
